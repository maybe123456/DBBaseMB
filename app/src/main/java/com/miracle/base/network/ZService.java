...
public interface ZService {
    ...
    @Headers({"BaseUrl:mi"})
    @POST("register")
    Call<ZResponse<UserBean>> registerCode(@Query("username") String username, @Query("password") String password, @Query("nickname") String nickname, @Query("smsCode") String smsCode);
    ...
    @Headers({"BaseUrl:mi"})
    @POST("smsCode")
    Call<ZResponse> sendSmsCode(@Query("phone") String phone);
