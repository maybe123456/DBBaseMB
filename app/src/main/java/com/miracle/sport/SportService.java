...
public interface SportService {
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Gamescity/circleDetail")
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Gamescity/tieziCommentList")
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Gamescity/sendTieziComment")
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Gamescity/clickTiezi")
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Gamescity/commentList")
...
//    Call<ZResponse<ArticleCommentBean>> sendCommentCommet(@Query("create_id") int id, @Query("content") String content, @Query("to_user_id") String to_user_id, @Query("type") String type);
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Gamescity/sendComment")
    Call<ZResponse<ArticleCommentBean>> sendCommentCommet(@Query("create_id") int id, @Query("content") String content, @Query("to_user_id") String to_user_id, @Query("type") String type);
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Gamescity/circleType")
...
//    Call<ZResponse<List<ChannerlKey>>> getSearchKeys();
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Gamescity/fishDetail")
...
//    @POST("home/fish/click")
     ...
     */
    @Headers({"BaseUrl:zh"})
    @POST("home/Gamescity/deleteComment")
