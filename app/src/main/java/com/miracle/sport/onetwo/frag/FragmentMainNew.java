...
import com.miracle.databinding.FragmentMainNewBinding;
import com.miracle.databinding.FragmentNewMainTopBinding;
...
public class FragmentMainNew extends HandleFragment<FragmentMainNewBinding>{
    public static String TAG = "TAG";
    public static int WHAT_GET_MARQUEE = 1;
    private static int WHAT_FLIP_TEXT = 10;

    FragmentNewMainTopBinding topBinding;
    ...
    public void initView() {
        ...
        topBinding = DataBindingUtil.inflate(LayoutInflater.from(getActivity()), R.layout.fragment_new_main_top, null, false);
        initTopHeader();
...
//        list.add("http://img0.imgtn.bdimg.com/it/u=1352823040,1166166164&fm=27&gp=0.jpg");
        list.add("file:///android_asset/lottery/banner01.png");
        list.add("file:///android_asset/lottery/banner03.png");
        list.add("file:///android_asset/lottery/banner05.png");
        list.add("file:///android_asset/lottery/banner06.png");
...
//                ToastUtil.toast("点击了第  " + position+"  项");
        ...
        topBinding.recycler.setAdapter(webBannerAdapter);
    }
